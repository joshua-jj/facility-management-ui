...
const IdentityCard: React.FC<IdentityCardProps> = ({
  ...
  return (
    <Link href={!disabled ? link : '#'} passHref>
      <div
        className={`group border border-gray-200 rounded-lg bg-white shadow hover:shadow-md flex flex-col justify-center items-center p-8 md:p-[88px] transition-all ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}
      >
