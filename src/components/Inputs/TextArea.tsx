   ...
   return (
      <div className="my-3">
         ...
         <textarea
            ...
            rows={props.rows || 6}
            className={`mt-1 block w-full border border-gray-300 dark:border-white/15 rounded-md px-3 py-2 bg-transparent placeholder:text-gray-400 dark:placeholder:text-white/25 focus:outline-none focus:ring-2 focus:ring-[#B28309]/40 focus:border-[#B28309] min-h-[120px] resize-none ${
               props.value
                  ? 'text-[#0F2552] dark:text-white'
