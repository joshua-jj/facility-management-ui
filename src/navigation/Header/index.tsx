...
const Header: React.FC = () => {
  return (
    <>
      <header className="flex items-center justify-between px-[35px] py-4 border border-[#e1e3e7] bg-white shadow-[0_16px_32px_0_rgba(189,189,189,0.25)] cursor-pointer relative">
